...
public class ModSounds {
  ...
  public static final RegistryObject<SoundEvent> HECTOR_SPAWN_SOUND = registerSoundEvent("hector_spawn_sound");
  ...
  private static RegistryObject<SoundEvent> registerSoundEvent(String name) {
    return SOUND_EVENTS.register(name,
        () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(FutUaiMod.MOD_ID, name)));
  }
